...
const (
	defaultFileName   = ".gcsspectre.yaml"
	alternateFileName = ".gcsspectre.yml"
)
...
type Config struct {
	...
	CheckPublic    *bool    `yaml:"check_public"`
	ExcludeBuckets []string `yaml:"exclude_buckets"`
	Timeout        string   `yaml:"timeout"`
}

// CheckPublicEnabled returns whether public access checking is enabled.
// Defaults to true if not set.
func (c *Config) CheckPublicEnabled() bool {
	if c.CheckPublic == nil {
		return true
	}
	return *c.CheckPublic
}
